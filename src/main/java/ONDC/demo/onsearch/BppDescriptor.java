...
public class BppDescriptor implements Serializable
{
    ...
    private final static long serialVersionUID = 7268741162077603845L;
    ...
    public String toString() {
        ...
        sb.append(BppDescriptor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
